...
<fieldset>
		...
		<form action="insert.php" method="post">
			...
			<input type="text" name="PositionN" size="5" />
			<label for="PositionN">°</label>
			<input type="text" name="MinutesN" size="3" />
			<label for="MinutesN">'</label>
			<input type="text" name="SecondsN" size="3" />
			<label for="SecondsN">"N</label>

			<input type="text" name="PositionE" size="5" />
			<label for="PositionE">°</label>
			<input type="text" name="MinutesE" size="3" />
			<label for="MinutesE">'</label>
			<input type="text" name="SecondsE" size="3" />
			<label for="SecondsE">"E</label>

			<label for="COG">COG</label>
			<input type="text" name="COG" size="10" />
			<label for="SOG">SOG</label>
			<input type="text" name="SOG" size="10" />
			...
			<input type="text" name="BTM" size="10" />
			<label for="DTM">DTM</label>
			<input type="text" name="DTM" size="10" />
			...
			<br />
			<label for="Manöver">Manöver</label>
			...
			<label for="Großsegel">Großsegel</label>
