...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="wrapper">
		<div id="page" class="container">
			<div id="content">
				...
				<div class="post">
					<h2 class="title">Links to third party sites</h2>
					<div class="entry">
						<p>
				...
				<div class="post">
					<h2 class="title">Google Analytics Disclaimer</h2>
					<div class="entry">
						<p>
			...
			<div id="sidebar">
				<div id="box1">
					...
					<ul class="list-style1">
						...
						<li class="first">
							<a href="#links">Links to third party sites</a>
						</li>
						<li class="first">
	...
	<!-- Mirrored from www.seapal.de/legal.php by HTTrack Website Copier/3.x [XR&CO'2010], Thu, 18 Oct 2012 15:54:21 GMT -->
</html>